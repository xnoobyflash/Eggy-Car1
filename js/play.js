...
function loadMainGame() {
  ...
  $(".game-iframe-container").html(
    '<iframe class="game-iframe" id="game-area" src="https://ubg77.github.io/edit/motoroadrash3d/" width="400" height="800" scrolling="none" frameborder="0" allowfullscreen=""></iframe>'
  );
...
function searchGame() {
  ...
  for (var j = 0; j < listGame.length; j++) {
    if (listGame[j].title.toUpperCase().indexOf(x.toUpperCase()) >= 0) {
      ...
      e.className =
        "column is-2-widescreen is-3-desktop is-4-tablet is-6-mobile show";
